...
| Microcontenido                                                                                                                                         | Detalle                                                                                                                                                                                                                                                                                                                        | 
|--------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **[Parte 1](https://github.com/juanrodace/J.HRAS/tree/main/Section02/Readme.md)**                                                                      | `Información básica para la modelación en HEC-RAS`                                                                                                                                                                                                                                                                             |
...
| **[Parte 2](https://github.com/juanrodace/J.HRAS/tree/main/Section03/Readme.md)**                                                                      | `Otras aplicaciones y estructuras de control de la herramienta`                                                                                                                                                                                                                                                                |
...
| **<font color="red">[Parte 3](https://github.com/juanrodace/J.HRAS/tree/main/Section04/Readme.md)</font>**                                               | `Modelación hidráulica 2D en HEC-RAS.`                                                                                                                                                                                                                                                                                         |
...
| [Tanque de alimentación asimétricos](Contenido/4.EPANET/Parte2/TanqueAsimetricos.md)                                                                    | Utilizando las herramientas de Epanet se incluirán tanques de alimentación con formas asimétrica (diferentes a un cubo o a un paralelepípedo) en un sistema hidráulico con una red de flujo a presión.                                                                                                                                                                                           | 
